...
namespace {
cl::opt<bool> optRelax ("relax-tbaa",
    cl::desc("ACCEPT: Relax type-based alias analysis"));
...
TypeBasedAliasAnalysis::alias(const Location &LocA,
  ...
  if (optRelax) {
    //If either instruction is elidable, there's no alias.
    const Value *V1 = LocA.Ptr;
    const Value *V2 = LocB.Ptr;
    Instruction *i1 = (Instruction *)V1;
    Instruction *i2 = (Instruction *)V2;
    if (elidable(i1) || elidable(i2))
      return NoAlias;
  }
